    ...
    <div class="row w-100">
        <div class=" col-sm shadow p-3 mb-3 bg-white rounded w-100 ml-5 mr-5 mt-2">
            ...
            <div class="form-group">
                ...
                <option value="servicio" <?php if($service['TYPE']=="servicio"){echo "selected" ;} ?> >Servicio</option>
                <option value="producto" <?php if($service['TYPE']=="producto"){echo "selected" ;} ?> >Producto</option>
                </select>
            </div>
            <div class="form-group">
                <label for="exampleInputEmail1">Nombre</label>
                <input type="text" class="form-control" name="ID" value="<?php echo $service['ID']?>">
...
<script src="<?php echo $GLOBALS['BASE_URL'] ?>publico/js/administracion/admin_service/admin_service_edit.js"></script>
<!-- HASTA AQUI-->
